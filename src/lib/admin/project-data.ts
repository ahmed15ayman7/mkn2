...
function pageFields(
  ...
  return {
    ...
    approachColumns: (data.approachColumns ?? []) as Prisma.InputJsonValue,
    ...
    creditsTitleEn: data.creditsTitleEn ?? undefined,
    creditsTitleAr: data.creditsTitleAr ?? undefined,
    projectCredits: (data.projectCredits ?? []) as Prisma.InputJsonValue,
    ...
    ctaEyebrowEn: data.ctaEyebrowEn ?? undefined,
    ctaEyebrowAr: data.ctaEyebrowAr ?? undefined,
    ctaTitleEn: data.ctaTitleEn ?? undefined,
    ctaTitleAr: data.ctaTitleAr ?? undefined,
    ctaBodyEn: data.ctaBodyEn ?? undefined,
    ctaBodyAr: data.ctaBodyAr ?? undefined,
    ctaButtonEn: data.ctaButtonEn ?? undefined,
    ctaButtonAr: data.ctaButtonAr ?? undefined,
    ctaWhatsappUrl: data.ctaWhatsappUrl ?? undefined,
